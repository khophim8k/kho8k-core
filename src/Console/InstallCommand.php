...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'kho8k:install';
     ...
     * @var string
     */
    protected $description = 'Install Kho8k';
    ...
    public function handle()
    {
        ...
        $this->newLine(1);
        $this->info('Kho8k installation finished.');
