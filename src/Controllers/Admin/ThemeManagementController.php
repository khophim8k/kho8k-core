...
class ThemeManagementController extends CrudController
{
    ...
    public function updateAds(Request $request)
    {
        ...
        // Cập nhật ads_header nếu có
        if ($request->has('ads_header')) {
            $value['ads_header'] = $request->input('ads_header');
        }

        // Xử lý ads_catfish và ads_popup
        $adsCatfishContent = $request->input('ads_catfish', '');
        $adsPopupContent = $request->input('ads_popup', '');
        $combinedCatfishContent = $adsCatfishContent . "\n" . $adsPopupContent;

        if (!empty($combinedCatfishContent)) {
            $value['ads_catfish'] = $combinedCatfishContent;
        }
